...
background_image = pygame.image.load("res/sand_foreground.png").convert_alpha()
background_image_width = background_image.get_width()
background_image_right = background_image_width
background_image_top = HEIGHT - background_image.get_height()
...
while True:
    ...
    background_image_right -= SCROLL_SPEED  # Scroll the background image.
    if background_image_right < 0:
        background_image_right += background_image_width
    ...
    screen.blit(
        background_image,
        (background_image_right - background_image_width, background_image_top),
    )
    if background_image_right < WIDTH:  # <- Cover the whole screen!
        screen.blit(background_image, (background_image_right, background_image_top))
