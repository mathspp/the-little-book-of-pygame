...
while True:
    ...
    screen.fill(BACKGROUND_COLOUR)
    sand_background.draw(screen)  # First, we draw the background sand...
    obstacles.draw(screen)  # ... then the obstacles...
    sand_foreground.draw(screen)  # ... and then the foreground sand.
