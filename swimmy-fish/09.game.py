...
top_obstacles = collections.deque()  # Don't forget to `import collections`!
...
while True:
    ...
    if next_obstacle_at <= pygame.time.get_ticks():
        ...
        top_obstacle = Obstacle(0, top_stop)  # We name this obstacle...
        obstacles.add(top_obstacle)  # ... so we can use it here...
        top_obstacles.append(top_obstacle)  # ... and here!
